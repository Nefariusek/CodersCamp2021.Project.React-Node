...
const SLIDE_3_TEXT =
  "You don't know which medications have expired?\nAnd when should you visit the pharmacy to buy new ones?";
...
const SLIDE_7_TEXT = 'Check when you should take your medication';
